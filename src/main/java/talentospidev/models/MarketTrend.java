...
public class MarketTrend {
    ...
    public void setHotSkills(List<String> hotSkills) {
    ...
    public List<NewsArticle> getRelevantArticles() {
        return relevantArticles;
    }

    public void setRelevantArticles(List<NewsArticle> relevantArticles) {
