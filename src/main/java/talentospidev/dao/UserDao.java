...
public class UserDao {
    ...
    /*
     * =========================
     * GOOGLE / OAUTH USER (coming sooooon)
     * =========================
     */
    ...
    /**
     * [UPDATE] Sets email_verified flag for a user.
     */
    public void setEmailVerified(int userId, boolean verified) {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            throw new RuntimeException("Error updating email_verified", e);
        }
    }
    ...
    private User map(ResultSet rs) throws SQLException {
        ...
        // Read email_verified (may not exist in older schemas — default false)
        try {
