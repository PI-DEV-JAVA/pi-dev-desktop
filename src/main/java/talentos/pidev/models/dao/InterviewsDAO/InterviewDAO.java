...
import talentos.pidev.models.schema.Interviews.Interview;
...
public class InterviewDAO {
    ...
    public void create(Interview i) {
        System.err.println(i.getStatus());
        System.err.println(i.getGeneralGrade());
    ...
    public void update(Interview i) {
        ...
        String sql = """
            UPDATE interview
            SET title=?, recruiter_id=?, candidate_id=?, status=?, general_grade=?
            WHERE id=?
        """;
