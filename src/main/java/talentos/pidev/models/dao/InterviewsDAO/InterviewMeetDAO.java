...
import talentos.pidev.models.schema.Interviews.InterviewMeet;
...
public class InterviewMeetDAO {
    ...
    public void create(InterviewMeet meet) {
        ...
        String sql = """
            INSERT INTO interview_meet
            (interview_id, meet_uuid, scheduled_at, status, grade)
            VALUES (?, ?, ?, ?, ?)
        """;
    ...
    public List<InterviewMeet> listByInterview(long interviewId) {
        ...
        String sql =
                "SELECT * FROM interview_meet WHERE interview_id=? ORDER BY scheduled_at ASC";
