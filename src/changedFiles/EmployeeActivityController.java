...
public class EmployeeActivityController {
    ...
    private void displayActivities() {
        ...
        sorted.sort((a, b) -> {
            ...
            if (statusA.equals("In Progress") && !statusB.equals("In Progress")) return -1;
            if (!statusA.equals("In Progress") && statusB.equals("In Progress")) return 1;
            if (statusA.equals("Overdue") && !statusB.equals("Overdue")) return -1;
            if (!statusA.equals("Overdue") && statusB.equals("Overdue")) return 1;
    ...
    private VBox createActivityCard(Activity activity) {
        ...
        if (status.equals("Overdue")) {
            borderStyle = baseStyle + " -fx-border-color: #ef4444; -fx-border-width: 0 0 0 4; -fx-border-radius: 14 0 0 14;";
            hoverBorderStyle = hoverStyle + " -fx-border-color: #ef4444; -fx-border-width: 0 0 0 4; -fx-border-radius: 14 0 0 14;";
        } else if (status.equals("In Progress")) {
            borderStyle = baseStyle + " -fx-border-color: #6366f1; -fx-border-width: 0 0 0 4; -fx-border-radius: 14 0 0 14;";
            hoverBorderStyle = hoverStyle + " -fx-border-color: #6366f1; -fx-border-width: 0 0 0 4; -fx-border-radius: 14 0 0 14;";
        } else if (status.equals("Completed")) {
            borderStyle = baseStyle + " -fx-border-color: #10b981; -fx-border-width: 0 0 0 4; -fx-border-radius: 14 0 0 14;";
            hoverBorderStyle = hoverStyle + " -fx-border-color: #10b981; -fx-border-width: 0 0 0 4; -fx-border-radius: 14 0 0 14;";
        } else {
    ...
    private void updateStatistics() {
        ...
        if (overallProgressBar != null)
            overallProgressBar.setProgress(totalAssignedHours > 0 ? Math.min(totalTrackedHours / totalAssignedHours, 1.0) : 0);
    }
